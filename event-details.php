...
$eid=intval($_GET['evntid']);
$isactive=1;
$sql = "SELECT tblcategory.CategoryName,tblevents.EventName,tblevents.EventPrice,tblevents.EventTicket,tblevents.EventLocation,tblevents.EventStartDate,tblevents.EventEndDate,tblevents.EventImage,tblevents.id,tblevents.EventDescription,tblevents.PostingDate,tblsponsers.sponserName,tblsponsers.sponserLogo,tblevents.EventImage from tblevents left join tblcategory on tblcategory.id=tblevents.CategoryId left join tblsponsers on tblsponsers.id=tblevents.SponserId where tblevents.id=:eid and tblevents.IsActive=:isactive";
$query = $dbh -> prepare($sql);
...
{ 
                            ...
                            <div class="about-left">
                                <div class="about-top">
                                    ...
                                    <div class="total-step">
                                        <div class="descp">
                                            <p style="text-align:justify; line-height:30px; color:black"><?php echo htmlentities($row->EventDescription);?></p>
                                        </div>
    ...
    <h3>Sponser</h3>
                                <div class="total-step">
                                    <div class="about-step">
                                        <h5 class="sub-title" style="font-size:3vw"><?php echo htmlentities($row->sponserName);?></h5>
                                        <div class="descp">
 <p><img src="admin/sponsers/<?php echo htmlentities($row->sponserLogo);?>" width="250" style="border:solid 1px #000"></p>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                             ...
                             <p align="center"><img src="admin/eventimages/<?php echo htmlentities($row->EventImage);?>" width="350" style="border: 4px solid #a8dadc";  ></p>
                            <div class="about-right" style="border: 2px solid #ff5733";>

                                <ul>
                                    
                                      <li><i class="zmdi zmdi-palette"></i><?php echo htmlentities($row->CategoryName);?> (Category)</li>
                                      <li>&#8377;<?php echo htmlentities($row->EventPrice);?> (Event Price)</li>
                                      <li><i class="zmdi zmdi-ticket-star"></i><?php echo htmlentities($row->EventTicket);?> (Event Tickets)</li>
