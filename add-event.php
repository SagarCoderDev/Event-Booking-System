...
$sql="INSERT INTO  tblevents(CategoryId,SponserId,EventName,EventPrice,EventTicket,EventDescription,EventStartDate,EventEndDate,EventLocation,EventImage,IsActive) VALUES(:catid,:spnserid,:ename,:eprice,:eticket,:ediscription,:esdate,:eedate,:elocation,:eventimage,:status)";
...
<input class="form-control" type="number" name="eventprice" autocomplete="off" required >
</div>

<!--Event ticket -->
<div class="form-group">
<label>Event Ticket</label>
<input class="form-control" type="number" name="eventticket" autocomplete="off" required autofocus>
</div>
