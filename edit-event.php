...
$sql="UPDATE  tblevents set CategoryId=:catid,SponserId=:spnserid,EventName=:ename,EventPrice=:eprice,EventTicket=:eticket,EventDescription=:ediscription,EventStartDate=:esdate,EventEndDate=:eedate,EventLocation=:elocation where id=:eid";
...
$query->bindParam(':eticket',$eticket,PDO::PARAM_STR);
...
<input class="form-control" type="number" name="eventprice" autocomplete="off" value="<?php echo htmlentities($result->EventPrice);?>" required >
</div>

<!--Event ticket -->
<div class="form-group">
<label>Event ticket</label>
<input class="form-control" type="number" name="eventticket" autocomplete="off" value="<?php echo htmlentities($result->EventTicket);?>" required >
</div>
